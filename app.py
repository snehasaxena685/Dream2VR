...
def process_video(input_path, sbs_path, anaglyph_path, max_disp=24, target_height=480, every_n=1, progress_callback=None):
    ...
    while True:
        ...
        if first_anaglyph_frame is None:
            first_anaglyph_frame = anaglyph
    ...
    return sbs_path, anaglyph_path, first_anaglyph_frame, total_frames, written_frames, out_fps
